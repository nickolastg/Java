...
public class BuscaBinaria01 {
    public static void main(String[] args) {
        ...
        System.out.println("Busca binária com números:");
        ...
        System.out.println("Busca binária com strings:");

        if (posicaoEncontradaString >= 0) {
            System.out.println("O nome " + nomes[posicaoEncontradaString] +
                " foi encontrado na posição " + posicaoEncontradaString);
        } else {
            System.out.println("Desculpe, o nome não foi encontrado :(");
        }
    }
